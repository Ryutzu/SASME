    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
          <h1 class="mb-0">
                            ...
                            <br>
                            <input type="button" value="Registra un doctor" onclick="location.href='agregarDoc.jsp'" class="mdl-button mdl-js-button mdl-button--primary" />
                            <br>
                            <br>
